function varargout = MontageParametersGUI_AV(varargin)
% MONTAGEPARAMETERSGUI_AV MATLAB code for MontageParametersGUI_AV.fig
%      MONTAGEPARAMETERSGUI_AV, by itself, creates a new MONTAGEPARAMETERSGUI_AV or raises the existing
%      singleton*.
%
%      H = MONTAGEPARAMETERSGUI_AV returns the handle to a new MONTAGEPARAMETERSGUI_AV or the handle to
%      the existing singleton*.
%
%      MONTAGEPARAMETERSGUI_AV('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MONTAGEPARAMETERSGUI_AV.M with the given input arguments.
%
%      MONTAGEPARAMETERSGUI_AV('Property','Value',...) creates a new MONTAGEPARAMETERSGUI_AV or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before MontageParametersGUI_AV_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to MontageParametersGUI_AV_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help MontageParametersGUI_AV

% Last Modified by GUIDE v2.5 13-Mar-2013 09:46:59

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @MontageParametersGUI_AV_OpeningFcn, ...
                   'gui_OutputFcn',  @MontageParametersGUI_AV_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before MontageParametersGUI_AV is made visible.
function MontageParametersGUI_AV_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MontageParametersGUI_AV (see VARARGIN)

% Choose default command line output for MontageParametersGUI_AV
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes MontageParametersGUI_AV wait for user response (see UIRESUME)
...
set(handles.IsSingle_AFAS_ForFirstTile_radiobutton, 'Value', GuiGlobalsStruct.MontageParameters.IsSingle_AFAS_ForFirstTile); % Added by AV on 3/12/13
...
function varargout = MontageParametersGUI_AV_OutputFcn(hObject, eventdata, handles) 
...
Value = get(handles.IsSingle_AFAS_ForFirstTile_radiobutton, 'Value'); % Added by AV 3/12/13
GuiGlobalStruct.MontageParameters.IsSingle_AFAS_ForFirstTile =Value; % Added by AV 3/12/13
...
% --- Executes on button press in IsSingle_AFAS_ForFirstTile.
%function IsSingle_AFAS_ForFirstTile_Callback(hObject, eventdata, handles)
% hObject    handle to IsSingle_AFAS_ForFirstTile (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of IsSingle_AFAS_ForFirstTile
