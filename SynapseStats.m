...
h3 = plot(1.2,MeanPre,'o', 'MarkerFaceColor', calx, 'MarkerEdgeColor','none', 'MarkerSize', 25 );
...
set(ax(1),'XTick', [1:3],'XTickLabel', {'group1'; 'group2'; 'group3'},'XLim', [0.5 3.5], 'FontName', 'Arial', 'FontSize', 20, 'Ycolor', [0.7,0,0]);
set(ax(2),'XTick', [1:3],'XTickLabel', {'group1'; 'group2'; 'group3'}, 'XLim', [0.5 3.5],'FontName', 'Arial', 'FontSize', 20, 'Ycolor' , [0,0.7,0]);
...
xlabel('Postsynaptic pathlenght in \mum', 'FontName', 'Arial', 'FontSize', 20);
ylabel('Count', 'FontName', 'Arial', 'FontSize', 20);
set(gca, 'FontName', 'Arial', 'FontSize', 20);
box off;
set(gcf,'color','w');
...
xlabel('Presynaptic pathlenght in \mum', 'FontName', 'Arial', 'FontSize', 20);
ylabel('Count', 'FontName', 'Arial', 'FontSize', 20);
set(gca, 'FontName', 'Arial', 'FontSize', 20);
box off;
set(gcf,'color','w');
...
xlabel('PostSynaptic cell', 'FontName', 'Arial', 'FontSize', 20);
ylabel('PreSynaptic cell', 'FontName', 'Arial', 'FontSize', 20);
set(gca, 'FontName', 'Arial', 'FontSize', 20);
box off;
set(gcf,'color','w');
axis square;
