...
plot(160-(Soma(1,2))/res, 80 -(Soma(1,3))/res,'Marker','o', 'MarkerFaceColor','w');
%plot XY soma location
plot(160-(Soma(1,2))/res, 90 + (Soma(1,1))/res,'Marker','o', 'MarkerFaceColor','w');
%plot YZ soma location
plot(160+(Soma(1,3))/res, 90 + (Soma(1,1))/res,'Marker','o', 'MarkerFaceColor','w');
