...
set(ax(1),'YColor','k','XDir','reverse','XTick',[0 20 40 60],'YLim',[0, max(postSynapsesXZ(:))],'XaxisLocation','top','FontName', 'Arial', 'FontSize', 40, 'LineWidth',2,'Position',[0.4,0.584,0.335,0.341]);
...
set(ax(1),'XLim',[20 140],'YColor','k','YLim',[0 max(postSynapsesXY(:))],'XDir','reverse','XTickLabel',[0,20,40,60,80,100,120],'FontName', 'Arial', 'FontSize', 40, 'LineWidth',4, 'Position',[0.13,0.22,0.335,0.341]);
...
plot(gca, [42.19+20, 42.19+20], [0, max(postSynapsesXY(:))], 'k--', 'LineWidth',4);
plot(gca, [55.08+20, 55.08+20], [0, max(postSynapsesXY(:))], 'k--','LineWidth',4);
plot(gca, [105.48+20, 105.48+20], [0, max(postSynapsesXY(:))], 'k--','LineWidth',4);
