function [tree,rawLength,specialPositions] = generateIrreducibleDoubleLinkedTree_WithDim(fileName,validNodeTypes,SpecialNodeType,uniformCSAreas,resolution)
