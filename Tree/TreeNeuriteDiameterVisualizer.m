function TreeNeuriteDiameterVisualizer(tree,highlightedNodes,inducingNodes,specialNodes,newFigure,validNodes)
%UNTITLED14 Summary of this function goes here
%   Detailed explanation goes here

rndclr = jet(length(inducingNodes));
symCell={'o','s','v','x','d','*'};
...
for kk=1:numel(tree)
    ...
    for mm=1:numel(children)
        ...
        h =  plot3(tempx,tempy,tempz,'color',rndclr(inducingNodes(kk),:),'lineWidth',2);
    end
end
