function [tree,rawLength] = generateIrreducibleDoubleLinkedTree(fileName,validNodeTypes,uniformCSAreas)

[nodes,edges,radii,~,~] = readSWCfile(fileName,validNodeTypes);
areas = pi*radii.^2;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [nodes,edges,radii,nodeTypes,abort] = readSWCfile(fileName,validNodeTypes)
...
%[nodes,edges,radii] = removeImproperRootNodes(nodes,edges,radii); % remove the root nodes until the first node
