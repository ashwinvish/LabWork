function [ ConHull,ConVol, X,Y,Z,htri1] = TreeConvexHull(tree,highlightedNodes,inducingNodes,specialNodes,newFigure,colorString,HullColor,validNodes,pixelUnits )
